...
from script.data.data_generation.Taxonomy import EngineTaxonomy, Node

"""
External script to generate dataset:
https://github.com/IPVS-AS/DataGenerator/blob/main/DataGenerator.py
"""
